...
- RUN PROGRESS: [x] P2-1 [x] P2-2 [x] P2-3 [x] P2-4 [x] P2-review [x] P2-fix [x] P3-1 [x] P3-2 [x] P3-3 [x] P3-review [x] P3-fix [ ] final-adversarial(x≤3) [ ] merge [ ] relaunch [ ] re-score+proof
